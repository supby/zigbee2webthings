...
// PostThingsDeviceIDActionsEndpoint executes the core logic of the related
// route endpoint.
func PostThingsDeviceIDActionsEndpoint(handler func(ctx *gin.Context, params *PostThingsDeviceIDActionsParams) *api.Response) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		params := NewPostThingsDeviceIDActionsParams()
...
// NewPostThingsDeviceIDActionsParams creates a new PostThingsDeviceIDActionsParams object
// with the default values initialized.
func NewPostThingsDeviceIDActionsParams() *PostThingsDeviceIDActionsParams {
	var ()
	return &PostThingsDeviceIDActionsParams{}
}

// PostThingsDeviceIDActionsParams contains all the bound params for the post things device ID actions operation
...
func (o *PostThingsDeviceIDActionsParams) readRequest(ctx *gin.Context) error {
	var res []error
...
func (o *PostThingsDeviceIDActionsParams) bindDeviceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
