...
// GetThingsDeviceNameEventsEndpoint executes the core logic of the related
// route endpoint.
func GetThingsDeviceNameEventsEndpoint(handler func(ctx *gin.Context, params *GetThingsDeviceNameEventsParams) *api.Response) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		params := NewGetThingsDeviceNameEventsParams()
...
// NewGetThingsDeviceNameEventsParams creates a new GetThingsDeviceNameEventsParams object
// with the default values initialized.
func NewGetThingsDeviceNameEventsParams() *GetThingsDeviceNameEventsParams {
	var ()
	return &GetThingsDeviceNameEventsParams{}
}

// GetThingsDeviceNameEventsParams contains all the bound params for the get things device name events operation
...
func (o *GetThingsDeviceNameEventsParams) readRequest(ctx *gin.Context) error {
	var res []error
...
func (o *GetThingsDeviceNameEventsParams) bindDeviceName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
