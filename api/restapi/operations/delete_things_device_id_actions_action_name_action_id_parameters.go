...
// DeleteThingsDeviceIDActionsActionNameActionIDEndpoint executes the core logic of the related
// route endpoint.
func DeleteThingsDeviceIDActionsActionNameActionIDEndpoint(handler func(ctx *gin.Context, params *DeleteThingsDeviceIDActionsActionNameActionIDParams) *api.Response) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		params := NewDeleteThingsDeviceIDActionsActionNameActionIDParams()
...
// NewDeleteThingsDeviceIDActionsActionNameActionIDParams creates a new DeleteThingsDeviceIDActionsActionNameActionIDParams object
// with the default values initialized.
func NewDeleteThingsDeviceIDActionsActionNameActionIDParams() *DeleteThingsDeviceIDActionsActionNameActionIDParams {
	var ()
	return &DeleteThingsDeviceIDActionsActionNameActionIDParams{}
}

// DeleteThingsDeviceIDActionsActionNameActionIDParams contains all the bound params for the delete things device ID actions action name action ID operation
...
func (o *DeleteThingsDeviceIDActionsActionNameActionIDParams) readRequest(ctx *gin.Context) error {
	var res []error
...
func (o *DeleteThingsDeviceIDActionsActionNameActionIDParams) bindActionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteThingsDeviceIDActionsActionNameActionIDParams) bindActionName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteThingsDeviceIDActionsActionNameActionIDParams) bindDeviceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
