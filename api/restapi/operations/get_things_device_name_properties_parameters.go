...
// GetThingsDeviceNamePropertiesEndpoint executes the core logic of the related
// route endpoint.
func GetThingsDeviceNamePropertiesEndpoint(handler func(ctx *gin.Context, params *GetThingsDeviceNamePropertiesParams) *api.Response) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		params := NewGetThingsDeviceNamePropertiesParams()
...
// NewGetThingsDeviceNamePropertiesParams creates a new GetThingsDeviceNamePropertiesParams object
// with the default values initialized.
func NewGetThingsDeviceNamePropertiesParams() *GetThingsDeviceNamePropertiesParams {
	var ()
	return &GetThingsDeviceNamePropertiesParams{}
}

// GetThingsDeviceNamePropertiesParams contains all the bound params for the get things device name properties operation
...
func (o *GetThingsDeviceNamePropertiesParams) readRequest(ctx *gin.Context) error {
	var res []error
...
func (o *GetThingsDeviceNamePropertiesParams) bindDeviceName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
