...
// GetThingsDeviceIDPropertiesEndpoint executes the core logic of the related
// route endpoint.
func GetThingsDeviceIDPropertiesEndpoint(handler func(ctx *gin.Context, params *GetThingsDeviceIDPropertiesParams) *api.Response) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		params := NewGetThingsDeviceIDPropertiesParams()
...
// NewGetThingsDeviceIDPropertiesParams creates a new GetThingsDeviceIDPropertiesParams object
// with the default values initialized.
func NewGetThingsDeviceIDPropertiesParams() *GetThingsDeviceIDPropertiesParams {
	var ()
	return &GetThingsDeviceIDPropertiesParams{}
}

// GetThingsDeviceIDPropertiesParams contains all the bound params for the get things device ID properties operation
...
func (o *GetThingsDeviceIDPropertiesParams) readRequest(ctx *gin.Context) error {
	var res []error
...
func (o *GetThingsDeviceIDPropertiesParams) bindDeviceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
