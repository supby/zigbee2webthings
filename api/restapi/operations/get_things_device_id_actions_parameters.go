...
// GetThingsDeviceIDActionsEndpoint executes the core logic of the related
// route endpoint.
func GetThingsDeviceIDActionsEndpoint(handler func(ctx *gin.Context, params *GetThingsDeviceIDActionsParams) *api.Response) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		params := NewGetThingsDeviceIDActionsParams()
...
// NewGetThingsDeviceIDActionsParams creates a new GetThingsDeviceIDActionsParams object
// with the default values initialized.
func NewGetThingsDeviceIDActionsParams() *GetThingsDeviceIDActionsParams {
	var ()
	return &GetThingsDeviceIDActionsParams{}
}

// GetThingsDeviceIDActionsParams contains all the bound params for the get things device ID actions operation
...
func (o *GetThingsDeviceIDActionsParams) readRequest(ctx *gin.Context) error {
	var res []error
...
func (o *GetThingsDeviceIDActionsParams) bindDeviceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
