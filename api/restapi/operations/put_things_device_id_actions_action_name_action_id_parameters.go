...
// PutThingsDeviceIDActionsActionNameActionIDEndpoint executes the core logic of the related
// route endpoint.
func PutThingsDeviceIDActionsActionNameActionIDEndpoint(handler func(ctx *gin.Context, params *PutThingsDeviceIDActionsActionNameActionIDParams) *api.Response) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		params := NewPutThingsDeviceIDActionsActionNameActionIDParams()
...
// NewPutThingsDeviceIDActionsActionNameActionIDParams creates a new PutThingsDeviceIDActionsActionNameActionIDParams object
// with the default values initialized.
func NewPutThingsDeviceIDActionsActionNameActionIDParams() *PutThingsDeviceIDActionsActionNameActionIDParams {
	var ()
	return &PutThingsDeviceIDActionsActionNameActionIDParams{}
}

// PutThingsDeviceIDActionsActionNameActionIDParams contains all the bound params for the put things device ID actions action name action ID operation
...
func (o *PutThingsDeviceIDActionsActionNameActionIDParams) readRequest(ctx *gin.Context) error {
	var res []error
...
func (o *PutThingsDeviceIDActionsActionNameActionIDParams) bindActionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PutThingsDeviceIDActionsActionNameActionIDParams) bindActionName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PutThingsDeviceIDActionsActionNameActionIDParams) bindDeviceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
