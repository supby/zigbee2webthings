...
// GetThingsDeviceNameActionsActionNameActionIDEndpoint executes the core logic of the related
// route endpoint.
func GetThingsDeviceNameActionsActionNameActionIDEndpoint(handler func(ctx *gin.Context, params *GetThingsDeviceNameActionsActionNameActionIDParams) *api.Response) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		params := NewGetThingsDeviceNameActionsActionNameActionIDParams()
...
// NewGetThingsDeviceNameActionsActionNameActionIDParams creates a new GetThingsDeviceNameActionsActionNameActionIDParams object
// with the default values initialized.
func NewGetThingsDeviceNameActionsActionNameActionIDParams() *GetThingsDeviceNameActionsActionNameActionIDParams {
	var ()
	return &GetThingsDeviceNameActionsActionNameActionIDParams{}
}

// GetThingsDeviceNameActionsActionNameActionIDParams contains all the bound params for the get things device name actions action name action ID operation
...
func (o *GetThingsDeviceNameActionsActionNameActionIDParams) readRequest(ctx *gin.Context) error {
	var res []error
...
func (o *GetThingsDeviceNameActionsActionNameActionIDParams) bindActionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetThingsDeviceNameActionsActionNameActionIDParams) bindActionName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetThingsDeviceNameActionsActionNameActionIDParams) bindDeviceName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
