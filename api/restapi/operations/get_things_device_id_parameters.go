...
// GetThingsDeviceIDEndpoint executes the core logic of the related
// route endpoint.
func GetThingsDeviceIDEndpoint(handler func(ctx *gin.Context, params *GetThingsDeviceIDParams) *api.Response) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		params := NewGetThingsDeviceIDParams()
...
// NewGetThingsDeviceIDParams creates a new GetThingsDeviceIDParams object
// with the default values initialized.
func NewGetThingsDeviceIDParams() *GetThingsDeviceIDParams {
	var ()
	return &GetThingsDeviceIDParams{}
}

// GetThingsDeviceIDParams contains all the bound params for the get things device ID operation
...
func (o *GetThingsDeviceIDParams) readRequest(ctx *gin.Context) error {
	var res []error
...
func (o *GetThingsDeviceIDParams) bindDeviceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
