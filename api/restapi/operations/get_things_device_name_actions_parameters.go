...
// GetThingsDeviceNameActionsEndpoint executes the core logic of the related
// route endpoint.
func GetThingsDeviceNameActionsEndpoint(handler func(ctx *gin.Context, params *GetThingsDeviceNameActionsParams) *api.Response) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		params := NewGetThingsDeviceNameActionsParams()
...
// NewGetThingsDeviceNameActionsParams creates a new GetThingsDeviceNameActionsParams object
// with the default values initialized.
func NewGetThingsDeviceNameActionsParams() *GetThingsDeviceNameActionsParams {
	var ()
	return &GetThingsDeviceNameActionsParams{}
}

// GetThingsDeviceNameActionsParams contains all the bound params for the get things device name actions operation
...
func (o *GetThingsDeviceNameActionsParams) readRequest(ctx *gin.Context) error {
	var res []error
...
func (o *GetThingsDeviceNameActionsParams) bindDeviceName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
