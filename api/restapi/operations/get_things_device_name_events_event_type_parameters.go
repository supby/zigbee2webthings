...
// GetThingsDeviceNameEventsEventTypeEndpoint executes the core logic of the related
// route endpoint.
func GetThingsDeviceNameEventsEventTypeEndpoint(handler func(ctx *gin.Context, params *GetThingsDeviceNameEventsEventTypeParams) *api.Response) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		params := NewGetThingsDeviceNameEventsEventTypeParams()
...
// NewGetThingsDeviceNameEventsEventTypeParams creates a new GetThingsDeviceNameEventsEventTypeParams object
// with the default values initialized.
func NewGetThingsDeviceNameEventsEventTypeParams() *GetThingsDeviceNameEventsEventTypeParams {
	var ()
	return &GetThingsDeviceNameEventsEventTypeParams{}
}

// GetThingsDeviceNameEventsEventTypeParams contains all the bound params for the get things device name events event type operation
...
func (o *GetThingsDeviceNameEventsEventTypeParams) readRequest(ctx *gin.Context) error {
	var res []error
	...
	rEventType := []string{ctx.Param("eventType")}
	if err := o.bindEventType(rEventType, true, formats); err != nil {
		res = append(res, err)
	}
...
func (o *GetThingsDeviceNameEventsEventTypeParams) bindDeviceName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetThingsDeviceNameEventsEventTypeParams) bindEventType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
