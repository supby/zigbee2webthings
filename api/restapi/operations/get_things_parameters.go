...
// GetThingsEndpoint executes the core logic of the related
// route endpoint.
...
// GetThingsParams contains all the bound params for the get things operation
...
func (o *GetThingsParams) readRequest(ctx *gin.Context) error {
	var res []error
