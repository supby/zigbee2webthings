...
func (m *PropertyDescription) validateLinks(formats strfmt.Registry) error {
...
func (m *PropertyDescription) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
